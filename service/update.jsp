...
<body>
	...
	%>
	<form class="container w-25 text-center" style="margin-top: 100px;" action="servicenowupdate" method="post">
		
		Enter Data to be Updated : <br><br>
